...
check_log_concave <- function(j,x,h) {
        ...
        ifelse(u_integral > h_integral, "upper bound segment > h(x)" , "ERROR upper bound segment < h(x)")
       ...
       ifelse(l_integral < h_integral, "lower bound segment < h(x)" , "ERROR lower bound segment > h(x)")
